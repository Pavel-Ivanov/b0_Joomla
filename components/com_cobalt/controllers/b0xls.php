...
class CobaltControllerB0Xls extends JControllerLegacy
{
	...
	protected $slogan = [
		'spareparts' => 'Запчасти для Renault Logan, Sandero, Duster, Kaptur, Dokker и Arkana',
		'accessories' => 'Аксессуары для Renault Logan, Sandero, Duster, Kaptur, Dokker и Arkana',
		'works' => 'Работы по ремонту Renault Logan, Sandero, Duster, Kaptur, Dokker и Arkana',
	];
	protected $email = [
		'from' => 'admin@logan-shop.spb.ru',
		'fromName' => 'Admin',
		'recipient' => 'p.ivanov@logan-shop.spb.ru',
	];

	// Вызов https://logan-shop.spb.ru/index.php?option=com_cobalt&task=b0xls.createXls&section=spareparts
	// Вызов https://logan-shop.spb.ru/index.php?option=com_cobalt&task=b0xls.createXls&section=accessories
	// Вызов https://logan-shop.spb.ru/index.php?option=com_cobalt&task=b0xls.createXls&section=works
