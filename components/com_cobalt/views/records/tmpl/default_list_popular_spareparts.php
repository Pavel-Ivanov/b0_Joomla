                ...
                <div class="uk-width-1-1">
                    <p class="lrs-article-title-related">
	                    <a href="<?php echo JRoute::_($item->url);?>"
                           ...
                           target="_blank">
		                    <?php echo get_title_popular($item->title, 50);?>
	                    </a>
                    </p>
                </div>
            </div>
            <div class="uk-grid">
                ...
                <div class="uk-width-2-3">
	                ...
	                <p class="lrs-price-related">
		                <?php render_price_popular($item->fields_by_id[30]->value, $is_item_by_order);?>
	                </p>
                </div>
            </div>
            </div>
...
<?php
function get_title_popular($title, $cut_len) {
	return ((mb_strlen($title) > $cut_len) ? (mb_substr($title, 0, $cut_len-3) . '...') : $title);
}

function render_price_popular($price, $is_item_by_order) {
	if ($is_item_by_order) {
