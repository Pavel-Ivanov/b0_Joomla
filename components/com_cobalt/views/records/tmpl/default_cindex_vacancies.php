...
/** @var JRegistry $paramsCindex */
$paramsCindex = $this->tmpl_params['cindex'];
b0dd($this->section);
$db  = JFactory::getDbo();
$query = "SELECT title, alias FROM #__js_res_record WHERE section_id={$section_id} AND type_id={$type_id}";
