...
$kaptur_2016_h4m_2wd = [
	...
	'items'  => [
		[
			'milage' => 15000,
			'tdHref'   => '/maintenance/item/3546-46a-tekhnicheskoe-obsluzhivanie-probeg-15000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 30000,
			'tdHref'   => '/maintenance/item/3548-47a-tekhnicheskoe-obsluzhivanie-probeg-30000-km',
			'type'     => 'oil-ign'
		],
		[
			'milage' => 45000,
			'tdHref'   => '/maintenance/item/3545-46b-tekhnicheskoe-obsluzhivanie-probeg-45000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 60000,
			'tdHref'   => '/maintenance/item/3549-47b-tekhnicheskoe-obsluzhivanie-probeg-60000-km',
			'type'     => 'oil-ign'
		],
		[
			'milage' => 75000,
			'tdHref'   => '/maintenance/item/3544-46c-tekhnicheskoe-obsluzhivanie-probeg-75000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 90000,
			'tdHref'   => '/maintenance/item/3551-48-tekhnicheskoe-obsluzhivanie-probeg-90000-km',
			'type'     => 'oil-ign-liq'
		],
		[
			'milage' => 105000,
			'tdHref'   => '/maintenance/item/3547-46d-tekhnicheskoe-obsluzhivanie-probeg-105000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 120000,
			'tdHref'   => '/maintenance/item/3550-47c-tekhnicheskoe-obsluzhivanie-probeg-120000-km',
			'type'     => 'oil-ign'
		]
	]
];
$kaptur_2016_f4r_4wd = [
	...
	'items'  => [
		[
			'milage' => 15000,
			'tdHref'   => '/maintenance/item/3536-43a-tekhnicheskoe-obsluzhivanie-probeg-15000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 30000,
			'tdHref'   => '/maintenance/item/3540-44a-tekhnicheskoe-obsluzhivanie-probeg-30000-km',
			'type'     => 'oil-ign'
		],
		[
			'milage' => 45000,
			'tdHref'   => '/maintenance/item/3537-43b-tekhnicheskoe-obsluzhivanie-probeg-45000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 60000,
			'tdHref'   => '/maintenance/item/3541-44b-tekhnicheskoe-obsluzhivanie-probeg-60000-km',
			'type'     => 'oil-ign'
		],
		[
			'milage' => 75000,
			'tdHref'   => '/maintenance/item/3538-43c-tekhnicheskoe-obsluzhivanie-probeg-75000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 90000,
			'tdHref'   => '/maintenance/item/3543-45-tekhnicheskoe-obsluzhivanie-probeg-90000-km',
			'type'     => 'oil-ign-liq'
		],
		[
			'milage' => 105000,
			'tdHref'   => '/maintenance/item/3539-43d-tekhnicheskoe-obsluzhivanie-probeg-105000-km',
			'type'     => 'oil'
		],
		[
			'milage' => 120000,
			'tdHref'   => '/maintenance/item/3542-44c-tekhnicheskoe-obsluzhivanie-probeg-120000-km',
			'type'     => 'oil-ign'
		]
	]
];
...
<div class="uk-grid data-uk-grid-margin">
    ...
    <div class="uk-width-small-4-10">
        <div class="uk-panel uk-panel-box uk-panel-box-secondary">
            <ul class="uk-list">
                <li><a href="#price">Сколько стоит техобслуживание Renault Kaptur</a></li>
                <li><a href="#why">Почему клиенты выбирают нас</a></li>
                <li><a href="#where">Где пройти техобслуживание Renault Kaptur</a></li>
...
<p>
    Регулярное техническое обслуживание автомобиля Рено Kaptur- это определяемый производителем список сервисных работ,
    выполняемых один раз в год или каждые 15 000 километров.
</p>
<p>
    Наш автосервис осуществляет качественное послегарантийное техобслуживание Рено Kaptur. Будьте уверены,
...
<div class="uk-panel uk-panel-box uk-margin-large-top">
    <h2 id="h1" class="uk-text-center">Стоимость технического обслуживания Renault Kaptur</h2>
...
<div class="uk-panel uk-panel-box uk-margin-top">
    <h4>с 2016 года выпуска</h4>
</div>
<div class="uk-overflow-container">
    <table class="uk-table ls-table-condensed">
		<?php thead_benzin(); ?>
        <tbody>
        <!-- Kaptur 1.6 16V 2WD с 2016 -->
            <?php tbody_tr($kaptur_2016_h4m_2wd);?>
        <!-- Kaptur 1.6 16V 4WD с 2016 -->
            <?php tbody_tr($kaptur_2016_f4r_4wd);?>
        </tbody>
    </table>
</div>
...
<div class="uk-panel uk-panel-box uk-margin-large-top uk-margin-bottom">
    <h2 id="where" class="uk-text-center">Где пройти техобслуживание Renault Kaptur</h2>
</div>
{module 158}
