	...
	<?php endif;?>
		...
		<div class="span<?php echo $span[$cols]?> has-context">
			<div class="album-box <?php echo $params->get('tmpl_params.well') ? 'well well-small' : NULL;?>">
				...
				<?php if(!empty($item->fields_by_id[$params->get('tmpl_params.field_id_gallery')]) && $item->fields_by_id[$params->get('tmpl_params.field_id_gallery')]->result):?>
					<?php echo $item->fields_by_id[$params->get('tmpl_params.field_id_gallery')]->result;?>
					<div class="clearfix"></div>
				<?php endif;?>
				
				<?php if(!empty($item->fields_by_id[$params->get('tmpl_params.field_id_descr')]) && $item->fields_by_id[$params->get('tmpl_params.field_id_descr')]->result):?>
					<div class="gall-description" style="margin-top: 5px;"><?php echo strip_tags($item->fields_by_id[$params->get('tmpl_params.field_id_descr')]->result);?></div>
				<?php endif;?>
